      ...
      >
        {title || (
          <span className="flex flex-col gap-3">
            <span className="text-4xl">Hey There 👋 I am</span><span className="text-6xl">Frontend Developer</span>
            <span className="text-2xl text-gray-500">Converting Ideas into Reality</span>
          </span>
        )}
      </motion.h2>
      {/* Lid */}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src={'/Kamlesh_Kaparvena.png'}
          alt="Kamlesh Kaparvena "
          fill
