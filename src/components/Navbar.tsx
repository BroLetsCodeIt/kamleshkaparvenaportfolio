...
import { AlignJustify, AlignLeft, Moon, Sun, SunMoon } from "lucide-react";
    ...
    <>
      <nav className="py-1 flex items-center justify-evenly top-0 w-[100%] text-center fixed  z-[50] mb-[2rem]  inset-x-0  bg-transparent  backdrop-blur-2xl">
        ...
        <Link href={"/"}>
          ...
          <p className="bg-gray-100/5 px-2 py-1 rounded-md font-semibold shadow-sm border-2 border-gray-100/10">
            Kamlesh kaparvena {">"}
          </p>
        </Link>
            ...
            <Sheet>
              ...
              <SheetContent className="w-[20rem]">
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Tech enthusiast with a passion for innovation and
                    problem-solving.
                  </SheetDescription>
                </SheetHeader>
                <Gallery />
