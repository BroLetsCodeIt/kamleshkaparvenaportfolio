    ...
    <div className=" mt-[10rem] min-h-[200vh] p-2 ">
      ...
      <div className="  flex flex-col container mx-auto  max-w-[45rem] rounded-tr-2xl">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-start justify-between flex-col gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span>
                Find 🔎 me on <Link href={'/'} target="_blank" className="font-bold">Twitter</Link> for tech Updates and Algorithms.
              </span>
            </div>
          </div>
          <Image
        ...
        <div className="flex items-start justify-start mt-20 flex-col gap-4">
          <h1 className="text-4xl font-bold pb-3 tracking-tight">Recent Blogs.</h1>

          {/* blog cards */}

          {/* 1st card */}
          <div className="flex border border-gray-400/0.7 rounded-md  w-full p-2 py-3 bg-[#F3F4F6] items-end justify-between px-2">
            <div className="flex flex-col">
           ...
           <Link href={'/'}>
            <p className="animate-pulse hover:-rotate-45 cursor-pointer">
        ...
        <p className="flex items-center justify-center pt-7 gap-2">
          See all Blogs{" "}
          <svg
            width="15"
            height="15"
